...
class _TypeMedia extends DataBaseConnection {

    function __construct() {
        parent::__construct();
    }

    //Recuperer la liste des TypeMedia
    function getAllTypeMedia() {
...
// Boucler sur les resultats            
    ...
    function getTypeMediaByID($id) {
        try {
            ...
            $query = "SELECT * FROM TypeMedia WHERE ID = :id";
