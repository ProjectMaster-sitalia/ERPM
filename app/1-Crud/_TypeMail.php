...
class _TypeMail extends DataBaseConnection {

    function __construct() {
        parent::__construct();
    }

    //Recuperer la liste des TypeMail
    function getAllTypeMail() {
...
// Boucler sur les resultats            
    ...
    function getTypeMailByID($id) {
        try {
            ...
            $query = "SELECT * FROM TypeMail WHERE ID = :id";
